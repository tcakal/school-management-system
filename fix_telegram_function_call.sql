-- FIX TELEGRAM FUNCTION SIGNATURE
-- The previous error 'function http_post(text, jsonb, unknown) does not exist' 
-- happened because we passed jsonb directly. We must cast it to text.
...
BEGIN
    ...
    LOOP
        ...
        IF v_reply_text IS NOT NULL THEN
            -- FIX: Cast JSON body to TEXT for http_post
